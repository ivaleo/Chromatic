...
if __name__ == "__main__":
    W45 = np.array(json.load(open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n5_cascade.json"))["k45"]["Q"])
    ...
    json.dump({"d": best_d, "Q": None if unpack(np.asarray(best_x)) is None
              ...
              open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n6_push45.json", "w"),
              indent=1)
