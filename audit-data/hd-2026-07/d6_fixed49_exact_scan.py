...
from d6_fixed7_campaign import DEFAULT_SOURCE, load_e6_source_rows
from prime_radon import load_forbidden, projective_forms
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=HERE / "fixed49_d6_294_exact.json",
    )
