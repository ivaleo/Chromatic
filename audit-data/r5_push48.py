...
cand = json.load(open("/Users/mac/Documents/_My_code/Chromatic/audit-data/r2_k48_candidate.json"))
Q0 = np.array(cand["Q"])
...
json.dump(out, open("/Users/mac/Documents/_My_code/Chromatic/audit-data/r5_push48.json", "w"), indent=1)
