...
def main():
    prev = json.load(open("/Users/mac/Documents/_My_code/Chromatic/audit-data/campaign_b.json"))
    out = {}
    ...
    json.dump(out, open("/Users/mac/Documents/_My_code/Chromatic/audit-data/r1_refined.json", "w"), indent=1)
