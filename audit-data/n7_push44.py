...
if __name__ == "__main__":
    W45 = np.array(json.load(open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n6_push45.json"))["Q"])
    ...
    with Pool(8) as pool:
        for k in (44, 43):
            ...
            if best_d < 1.0:
                break
    json.dump(out, open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n7_push44.json", "w"),
              indent=1)
