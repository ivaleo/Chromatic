...
INPUT = sys.argv[1] if len(sys.argv) > 1 else \
    "/Users/mac/Documents/_My_code/Chromatic/audit-data/r5_k48_rational.json"
L0 = F(sys.argv[2]) if len(sys.argv) > 2 else F(10396, 10000)
OUT = sys.argv[3] if len(sys.argv) > 3 else \
    "/Users/mac/Documents/_My_code/Chromatic/audit-data/cert48.json"
