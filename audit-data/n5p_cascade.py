...
if __name__ == "__main__":
    W46 = np.array(json.load(
        open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n4_push46.json"))["Q"])
    out = {}
    with Pool(8) as pool:
    ...
    json.dump(out, open("/Users/mac/Documents/_My_code/Chromatic/audit-data/n5_cascade.json",
                        "w"), indent=1)
