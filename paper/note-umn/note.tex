...
% решётка индекса 43 и точный верификатор 1029 (Н.\,В.~Глушкова).
...
В каждом из трёх случаев \eqref{crit} даёт утверждение теоремы; для каждого
из них проверка независимо повторена второй программой без общих
геометрических процедур.
