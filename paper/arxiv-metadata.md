...
> **короткая английская версия** `arxiv-en/bounds-en.tex` (9 страниц, все
...
> дополнения. Для выделенных документов (`article1/bounds.tex`,
> `article2/widths.tex`, `note-dan/dan.tex`,
> `arxiv-en/bounds-en.tex` — у последнего метаданные уже в его README) метаданные готовятся отдельно
> после решения авторов о целевых журналах; аннотации каждого документа уже
> лежат в его каркасе (статьи) и в `note-dan/README.md` (сообщение). Если на
