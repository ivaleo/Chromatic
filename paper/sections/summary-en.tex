...
$1029$, $9604$, $45619$; the sharper $7203$ and $28812$ have status
...
over $E_6^*/343$). In $\R^9$ these bounds carry status \stN: the
floating-point computation is reduced to evaluating explicit quadratics at
vertices of explicit polytopes, but the final rational write-up has not been
carried out, so they are kept out of the title. In $\R^7$ that write-up
\emph{has} been carried out (Theorem~\ref{thm:r7ex}): all $30\,368$ vertices
...
($1\,600$ vertices have nine active facets). Hence $1029$ has status \stC{}
and enters the title.
