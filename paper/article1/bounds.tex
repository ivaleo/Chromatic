...
\thanks{Код, точные сертификаты, данные и журнал вычислительных кампаний
(включая отрицательные экраны) открыты~\cite{Repo}:
...
опровергается гипотеза Армана, Бондаренко, Прымака и Радченко, что $49$ и
...
продуктового правила для ширин $\sum_i1/d_i^2\le1$ и полученной проекцией на плоскость нижней границы
