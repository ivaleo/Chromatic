...
$140$ минимальны среди всех решёточных раскрасок $\R^4$ и $\R^5$. Первые три
оценки даются явными рациональными решётками --- эйзенштейновой в $\R^4$,
общего положения в $\R^5$ и ламинированием $E_6^*/343$ в $\R^7$, --- а
ключевое неравенство по единому протоколу сведено к конечному списку
неравенств между рациональными числами, проверенных в точной арифметике.
Последние две выводятся аналитически из продуктового правила для ширин
$\sum_i1/d_i^2\le1$ и планарной нижней границы
...
$\chi(\R^4)\le43$, $\chi(\R^5)\le132$, $\chi(\R^7)\le1029$,
$\chi(\R^9)\le9604$, and $\chi(\R^{10})\le45619$, against the previously
...
first three bounds come from explicit rational lattices --- an Eisenstein
lattice in $\R^4$, a lattice in general position in $\R^5$, and a lamination
of $E_6^*/343$ in $\R^7$ --- whose key inequality is reduced, by a single
verification protocol, to a finite list of inequalities between rational
numbers checked in exact arithmetic. The last two follow analytically from a
product rule for widths, $\sum_i1/d_i^2\le1$, and the planar lower bound
...
\bibitem{Widths} Л.~Л.~Иванов, Н.~Глушкова,
