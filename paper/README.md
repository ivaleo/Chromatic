# paper/ — статья об оценках χ(ℝ⁴) ≤ 43, χ(ℝ⁵) ≤ 132, χ(ℝ⁷) ≤ 1029, χ(ℝ⁹) ≤ 9604 и χ(ℝ¹⁰) ≤ 45619

*(в заголовке — только доказанные оценки, статусы [Т]/[С]; численно, со статусом [Ч],
получены более сильные 7203 и 28812 — см. шкалу статусов в конце введения)*
...
Полная рукопись `chi4-43.tex` (68 страниц) остаётся **электронным
...
|---|---|---|
| [`article1/`](article1/) | статья 1 (`bounds.tex`) | пять доказанных оценок, протокол точной проверки, три конструкции, продуктовое исчисление |
...
| [`note-umn/`](note-umn/) | краткое сообщение УМН (`note.tex`) | все пять оценок: явные конструкции 43/132/1029 с точными инвариантами и продуктовое правило для 9604/45619; 3 страницы официального шаблона |
