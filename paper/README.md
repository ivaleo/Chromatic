...
| [`note-dan/`](note-dan/) | краткое сообщение для Докладов РАН (`dan.tex`, 15.09.2026) | короткая статья на лимит 25 000 знаков: все пять оценок, четыре конструкции с данными, протокол точной проверки, вывод 45619 с доказательствами; стиль `dan2e.sty`, 5 страниц |
