...
Основной итог исследования. Исходник — [`chi4-43.tex`](chi4-43.tex), собранный
PDF — `chi4-43.pdf`.

## Комплект публикации (с 03.09.2026)

Полная рукопись `chi4-43.tex` (69 страниц) остаётся **электронным
дополнением**; из неё выделены три самостоятельных документа, каждый со
своим каркасом, разделами и README:

| Каталог | Документ | Состав |
|---|---|---|
| [`article1/`](article1/) | статья 1 (`bounds.tex`) | пять доказанных оценок, протокол точной проверки, четыре конструкции, продуктовое исчисление |
| [`article2/`](article2/) | статья 2 (`widths.tex`) | эйзенштейново тождество, лестницы ширин, ламинирование и кандидаты, экраны индекса, мозаики |
| [`note-umn/`](note-umn/) | краткое сообщение УМН (`note.tex`) | все пять оценок: явные конструкции 43/132/1029/7203 с точными инвариантами и продуктовое правило для 45619; официальный шаблон; двухстраничный вариант `note-2p.tex` без 45619 |
| [`note-dan/`](note-dan/) | краткое сообщение для Докладов РАН (`dan.tex`, 14.09.2026) | аналитическая часть без пересечения с УМН: тождество для эйзенштейновых решёток, точные ширины, продуктовое правило, 45619 / 4·7¹² / 19·7¹², пол 2401 на E₈; стиль `dan2e.sty`, 6 страниц |
| [`arxiv-en/`](arxiv-en/) | короткая английская версия для arXiv (`bounds-en.tex`, 14.09.2026) | все пять оценок с данными четырёх сертификатов, тождество, продуктовое правило, пол на E₈; 8 страниц, только английский |
