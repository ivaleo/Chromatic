...
| [`note-umn/`](note-umn/) | краткое сообщение УМН (`note.tex`) | все пять оценок: явные конструкции 43/132/1029/7203 с точными инвариантами и продуктовое правило для 45619; официальный шаблон |
