...
- `hd-2026-07/metric_deform_a5_132_refined_certificate.json` —
...
- `hd-2026-07/metric_deform_a5_132_refined_independent_exact_audit.json`
  — независимый точный аудит той же конструкции без Qhull;
- `hd-2026-07/exact_prime_threshold_a5_131_escape_refine_round3.json` и
  `hd-2026-07/active_metric_a5_131_escape_frontier_independent_exact_d1000000.json`
...
- `hd-2026-07/metric_deform_e7_1323_certificate.json` — рациональный сертификат
  новой оценки χ(ℝ⁷) ≤ 1323 (39 296 точных вершинных систем и 70 точных
  KKT-сертификатов расстояния);
- `hd-2026-07/a9_orbit_16875.json`, `a9_orbit_17150.json` и
...
- `hd-2026-07/portfolio_bridge_d6_342_340_seed6342001.json` и
...
- `hd-2026-07/fixed7_d6_336_*.json`,
...
- `hd-2026-07/highs_outer_d6_336_*.json`,
...
- `hd-2026-07/highs_index_refine_d6_*.json` и
...
- `hd-2026-07/d6_torus_{column_generation,multilift,period_portfolio,index_sweep}.py`
...
- `hd-2026-07/d6_torus_{prime_exhaustive,fourier_lp}.py`,
...
- `hd-2026-07/d6_{cyclic_hole_search,cyclic_highs_neighborhood,affine_metric_opt,affine_active_refine,affine_sdp_hybrid,cyclic_block_search}.py`
...
- `hd-2026-07/fixed49_d6_294_exact.json` и
