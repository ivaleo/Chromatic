...
| [`note-dan/`](note-dan/) | краткое сообщение для Докладов РАН (`dan.tex`, 14.09.2026) | аналитическая часть: тождество для эйзенштейновых решёток, точные ширины, продуктовое правило, 45619 / 4·7¹² / 19·7¹², пол 2401 на E₈; стиль `dan2e.sty`, 6 страниц |
