...
\newcommand{\stP}{\textcolor{ForestGreen}{\textbf{[Т]}}}     % теорема
\newcommand{\stC}{\textcolor{RoyalBlue}{\textbf{[С]}}}       % точный сертификат
\newcommand{\stN}{\textcolor{BurntOrange}{\textbf{[Ч]}}}     % численный (повышенной пробы)
\newcommand{\stM}{\textcolor{BurntOrange}{\textbf{[Ч]}${}^{*}$}} % кандидат без сертификата
...
(сертификат в плавающей точке); ${}^{*}$~--- кандидат без сертификата
диаметра. Определения шкалы --- в конце введения.}
...
\thanks{Черновик от 09.08.2026. Аффилиации и контактные данные авторов подлежат
...
но со сдвигами слоёв внутри ячейки $E_8$ --- вместе с полосным сертификатом
диаметра опускает оценку до $28812$.
